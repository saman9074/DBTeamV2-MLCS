...
local function run(msg, matches)
	...
	elseif matches[1] == "ch" and matches[2] then
 				send_msg(msg.to.id, "http://api.program-o.com/v2/chatbot/?bot_id=12&say="..matches[2].."&convo_id=".. msg.from.first_name or msg.from.username or msg.from.last_name .. "_" .. msg.id .. "&format=json", 'md')
