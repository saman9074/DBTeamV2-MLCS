...
local function run(msg, matches)
	    ...
	    elseif matches[1] == "all" or matches[1] == lang_text(msg.to.id, 'allCommand') and not matches[3] and permissions(msg.from.id, msg.to.id, "settings") and redis:get("moderation_group: " .. msg.to.id) then
			if matches[2] == 'off' or matches[2] == lang_text(msg.to.id, 'offCommand') then
			-- tgservices --
			redis:set("settings:tgservices:" .. msg.to.id, true)
			-- invite --
